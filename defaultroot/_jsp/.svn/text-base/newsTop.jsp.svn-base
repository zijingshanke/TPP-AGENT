...
<div id="head">
      ...
      <img src="../_img/phone.gif"/>&nbsp;：<i style="font-size: 20px;color: red;">0756-8801800</i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        您可以：<a href="<%=request.getContextPath()%>/agent/agent.do?thisAction=toRegister" style=" border:none;">注册</a> <a href="<%=request.getContextPath() %>/help/index.jsp" style=" border:none;">帮助中心</a><a href="<%=request.getContextPath()%>/login.jsp">返回登录</a>
      </span>
