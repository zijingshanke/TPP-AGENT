...
<%
	...
	String basePath = request.getScheme() + "://"
			...
			+ path + "/";
%>
<!--JSP页面: security/interface_updatePassword.jsp -->
<html>
	<head>
	...
	<body>
		<div id="warp">
			<div class="nav">
				<div class="nav_a">
					<div class="nav_b">
						<span class="font_style3">修改密码</span>
					</div>
				</div>
			</div>
			<div class="id_card">
				<c:if test="${error eq 'yes'}">
					...
					<div class="id_card_already_right">
						<c:forEach var="error" items="${errorlist}">
							<em class="tipsPayway" style="color: red;"><font size="4"><c:out
										value="${error}"></c:out> </font> </em>
						</c:forEach>
				</c:if>
				<c:if test="${error eq null or error eq ''}">
					<img src="../_img/alreday.gif" />
					<div class="id_card_already_right">
						<em class="tipsPayway" style="color: red;"><font size="6">请牢记您设置的支付密码</font>
						</em>
				</c:if>
			</div>
			<div>
		...
		<div id="container" class="register">
			<html:form
				action="/security/security.do?thisAction=interfaceChangePassword">
									...
									<tr>
										...
										<td>
											<input type="password" name="password" id="password"
												class="text_style" rule="length:6:20" value=""/>
										</td>
										<td>第一次修改支付密码为：222222</td>
									...
									<tr>
										...
										<td>
											<input type="password" name="repassword" id="repassword"
												...
												onblur="lengthBetween('repassword','repasswordTip',6,20,'您设置的登录密码有误，登录密码应该由6-20个英文字母、数字或符号组成。')"
												rule="length:6:20" />
										</td>
										<td style="width: 470px; text-align: left">
									...
									<tr>
										...
										<td>
											<input type="password" name="repassword2" id="repassword2"
												...
												onblur="lengthBetween('repassword2','repasswordTip2',6,20,'您设置的登录密码有误，登录密码应该由6-20个英文字母、数字或符号组成。');"
												rule="length:6:20" />
										</td>
										<td style="width: 470px; text-align: left">
