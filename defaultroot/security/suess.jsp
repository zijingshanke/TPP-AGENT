...
<!--JSP页面: agentUser/modifyAgentUserPasswordSuccess.jsp -->
  <head>
        ...
        <div class="main_mid">
          <div class="main_title">
            <div class="main_title_right">
              <p><strong>证书导入</strong></p>
            </div>
          </div>
          
          <div class="sendToEmail modifySuccess">
          	<div class="sendToEmailTitle modifySuccessTitle">
            	<em>您已成功安装证书！原有的证书备份文件下次仍可以使用，请妥善保管。
            	请<a href="../agent/agent.do?thisAction=removeSession">重新登录</a></em>
            	<br></br>
            </div>
            </ul>
          </div>
