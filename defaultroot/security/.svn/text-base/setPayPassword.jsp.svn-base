...
<html:form action="/agent/agent.do?thisAction=setPayPassword">
   <input type="hidden" name="loginName" value="<c:out value="${loginName}" ></c:out>"/>
          <table cellpadding="0" cellspacing="0" width="100%" class="information_table">
            <tr>
              ...
              <td style="text-align: left"><span class="font_style2"><c:out value="${loginName}" ></c:out></span></td>
            </tr>
			<tr>
            ...
            <tr>
              ...
              <td style="text-align: left"><html:password property="repassword2" styleClass="inputText"></html:password></td>
            </tr>
            <tr><td>&nbsp;</td>
