		      ...
		      <ul>
			    ...
			    <ul>
				   <li><a href="sjfw1.jsp"><span>第一步</span></a></li>
				    <li><a href="sjfw2.jsp"><span class="now">第二步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">输入您想绑定的手机号码</div>
					<div class="demoGifP">
						<a href="sjfw3.jsp"><img src="../_img/help/demo/sjfw2.gif" alt="手机服务" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
