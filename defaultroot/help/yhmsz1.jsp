...
<div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 用户名设置</span></div>
					<div class="navlist">
			    <ul>
				    <li><a href="yhmsz1.jsp"><span class="now">第一步</span></a></li>
				    <li><a href="yhmsz2.jsp"><span>第二步</span></a></li>
				    <li><a href="yhmsz3.jsp"><span>第三步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">没有实名认证前，可以修改账户名</div>
					<div class="demoGifP">
						<a href="yhmsz2.jsp"><img src="../_img/help/demo/yhmsz1.gif" alt="个人注册" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
