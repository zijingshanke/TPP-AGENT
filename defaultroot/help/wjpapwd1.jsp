 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				    <li><a href="wjpapwd1.jsp"><span class="now">第一步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">找回交易密码</div>
					<div class="demoGifP">
						<a href="wjpapwd2.jsp"><img src="../_img/help/demo/wjpapwd1.gif" alt="忘记交易密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
