										...
										<table width="100%" cellpadding="0" cellspacing="0" class="tablebanking">
										  <thead>
											<tr class="bankTitle"  bgcolor="#FDFDD0">
											  <td colspan="5"><strong>中国建设银行</strong>&nbsp;网银支付信息</td>
										    </tr>
											<tr>
											  <td>&nbsp;</td>
											  <td colspan="2">非签约用户和文件证书用户</td>
											  <td colspan="2">USBKEY+口令卡</td>
											</tr>
										  </thead>
											<tr>
											  <td>&nbsp;</td>
											...
											<tr>
											  ...
											  <td colspan="4" align="left">自2008年6月14日起，建行停止文件证书和非签约用户的网上支付功能。用户可到建行网点柜面开通USBKEY和口令卡。</td>
											</tr>
										</table>
									<div class="helpAbout">
										相关问题：
