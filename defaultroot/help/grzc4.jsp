 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
			    	<li><a href="grzc1.jsp"><span>第一步</span></a></li>
				    <li><a href="grzc2.jsp"><span>第二步</span></a></li>
				    <li><a href="grzc3.jsp"><span>第三步</span></a></li>
				    <li><a href="grzc4.jsp"><span class="now">第四步</span></a></li>
				    <li><a href="grzc5.jsp"><span>第五步</span></a></li>
				    <li><a href="grzc6.jsp"><span>第六步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">点击“激活钱门账户”按钮</div>
					<div class="demoGifP">
						<a href="grzc5.jsp"><img src="../_img/help/demo/grzc4.gif" alt="个人注册" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
