 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="wjpwd3.jsp"><span>第三步</span></a></li>
				    <li><a href="wjpwd4.jsp"><span>第四步</span></a></li>
				    <li><a href="wjpwd5.jsp"><span>第五步</span></a></li>
				    <li><a href="wjpwd6.jsp"><span class="now">第六步</span></a></li>
				    <li><a href="wjpwd7.jsp"><span>第七步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">设置您的新登录密码</div>
					<div class="demoGifP">
						<a href="wjpwd7.jsp"><img src="../_img/help/demo/wjpwd6.gif" alt="忘记登录密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
