		...
		<div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="grzc2.jsp"><span class="now">第二步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">选择用户类型：个人用户，依次填写注册信息</div>
					<div class="demoGifP">
						<a href="grzc3.jsp">
						<img src="../_img/help/demo/grzc2.gif" alt="个人注册" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
