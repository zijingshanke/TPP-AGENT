 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="ghtx2.jsp"><span class="now">第二步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">更换自己喜欢的头像</div>
					<div class="demoGifP">
						<a href="ghtx3.jsp"><img src="../_img/help/demo/ghtx2.gif" alt="头像设置" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
