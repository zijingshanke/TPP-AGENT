						...
						<div class="rightbox_count">
							...
							<div class="contentRight">
								<div class="helpdetailed">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;
									<b>当您的账户需要冻结和解冻时，您可联系QQ客服或者致电客服热线进行冻结和解冻。</b><br/>
									<br/>您需要提供的材料：您的钱门账户，您的身份证扫描件或传真件（可用数码相机拍摄）；如果您需要冻结的是与您交易的对方，则需要提供交易号，对方联系方式和投诉原因。<br/>
									<br/>具体流程
									<br/>A．您可以通过以下三种方式将以上几项信息告知客服中心<br/>
									<br/>1、邮件方式：从您的钱门账户中发邮件到qmpay@qmpay.com。邮件中写明您的钱门账户，并附上您的身份证扫描件或照片。（如需要冻结的是与您交易的对方，则需要提供交易号，对方联系方式和投诉原因）。
									<br/>2、传真方式：您可以将您的快钱账户，并附上您的身份证扫描件或照片（如需要冻结的是与您交易的对方，则需要提供交易号，对方联系方式和投诉原因）一起传真到客服中心。传真号码：0756-8801800。
									<br/>3、QQ方式：您可以在帮助主页找到QQ在线客服，并在线对您的身份进行核实（如需要冻结的是与您交易的对方，则需要提供交易号，对方联系方式和投诉原因）。<br/>
									<br/>B．客服人员收到您的申请后，核实信息无误后进行冻结和解冻的操作。 
									<div class="helpAbout">
										相关问题：
									</div>
