							...
							<div class="contentRight">
								<div class="helpdetailed">
									<h1>
										...
										一、动态密码<br />
										钱门盾每次实时生成不同的密码，避免了因静态密码被盗导致的账户安全风险。<br />
										<br />
										二、一次性密码<br />
										产生的动态密码只能被用户使用一次，无法重复使用。一次性密码增强了安全性。<br />
										<br />
										三、随机性<br />
										动态密码是随机生成、无规律的。即使本次密码被窃取，也难以由此猜出下次的密码。<br />
										<br />
										四、不可拆解<br />
										为了防止非法持有者通过改动钱门盾内部零件窃取密码，钱门盾不能拆解，一旦强行拆解，钱门盾将会自动报废。 
									<div class="helpAbout">
										相关问题：
									</div>
