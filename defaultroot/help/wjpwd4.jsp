 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="wjpwd4.jsp"><span class="now">第四步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">激活邮件链接</div>
					<div class="demoGifP">
						<a href="wjpwd5.jsp"><img src="../_img/help/demo/wjpwd4.gif" alt="忘记登录密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
