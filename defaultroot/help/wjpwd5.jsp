...
<div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="wjpwd5.jsp"><span class="now">第五步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">输入证件号码</div>
					<div class="demoGifP">
						<a href="wjpwd6.jsp"><img src="../_img/help/demo/wjpwd5.gif"  alt="忘记登录密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
