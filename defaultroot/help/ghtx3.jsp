 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="ghtx3.jsp"><span class="now">第三步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">浏览本地图片</div>
					<div class="demoGifP">
						<a href="ghtx4.jsp"><img src="../_img/help/demo/ghtx3.gif" alt="头像设置" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
