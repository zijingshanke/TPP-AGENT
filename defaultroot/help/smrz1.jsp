 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				    <li><a href="smrz1.jsp"><span class="now">第一步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">实名认证后才可提现操作</div>
					<div class="demoGifP">
						<a href="smrz2.jsp"><img src="../_img/help/demo/smrz1.gif" alt="实名认证" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
