 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="smrz4.jsp"><span>第四步</span></a></li>
				    <li><a href="smrz5.jsp"><span>第五步</span></a></li>
				    <li><a href="smrz6.jsp"><span class="now">第六步</span></a></li>
				    <li><a href="smrz7.jsp"><span>第七步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">输入在银行查到钱门的验证金额</div>
					<div class="demoGifP">
						<a href="smrz7.jsp"><img src="../_img/help/demo/smrz6.gif" alt="实名认证" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
