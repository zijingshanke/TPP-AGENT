...
<div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				   <li><a href="ptcz1.jsp"><span>第一步</span></a></li>
				    <li><a href="ptcz2.jsp"><span>第二步</span></a></li>
				    <li><a href="ptcz3.jsp"><span class="now">第三步</span></a></li>
					...
					<div class="demoGifP">
						<a href="ptcz4.jsp"><img src="../_img/help/demo/ptcz3.gif" alt="充值" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
