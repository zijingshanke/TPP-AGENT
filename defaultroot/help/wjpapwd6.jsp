 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="wjpapwd6.jsp"><span class="now">第六步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">找回交易密码成功</div>
					<div class="demoGifP">
						<a href="#"><img src="../_img/help/demo/xgpapwd3.gif" alt="忘记交易密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
