 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				   <li><a href="qtcz1.jsp"><span>第一步</span></a></li>
				    <li><a href="qtcz2.jsp"><span class="now">第二步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">选择银行，输入充值金额</div>
					<div class="demoGifP">
						<a href="qtcz3.jsp"><img src="../_img/help/demo/qtcz2.gif" alt="给其他账户充值" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
