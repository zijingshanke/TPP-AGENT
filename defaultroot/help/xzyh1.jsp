...
<div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				   <li><a href="xzyh1.jsp"><span class="now">第一步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">新增提现银行</div>
					<div class="demoGifP">
						<a href="xzyh2.jsp"><img src="../_img/help/demo/xzyh1.gif" alt="新增提现银行" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
