		...
		<div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="grzc3.jsp"><span class="now">第三步</span></a></li>
				    <li><a href="grzc4.jsp"><span>第四步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">注册成功，去邮箱查收邮件</div>
					<div class="demoGifP">
						<a href="grzc4.jsp"><img src="../_img/help/demo/grzc3.gif" alt="个人注册" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
