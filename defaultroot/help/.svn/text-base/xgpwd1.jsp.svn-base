 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				    <li><a href="xgpwd1.jsp"><span class="now">第一步</span></a></li>
				    <li><a href="xgpwd2.jsp"><span>第二步</span></a></li>
				    <li><a href="xgpwd3.jsp"><span>第三步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">修改登录密码</div>
					<div class="demoGifP">
						<a href="xgpwd2.jsp"><img src="../_img/help/demo/xgpwd1.gif" alt="修改登录密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
