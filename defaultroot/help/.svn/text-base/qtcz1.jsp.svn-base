...
cha.className="changehelp";
 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 给其他账户充值</span></div>
					<div class="navlist">
			    <ul>
				   <li><a href="qtcz1.jsp"><span class="now">第一步</span></a></li>
				    <li><a href="qtcz2.jsp"><span>第二步</span></a></li>
				    <li><a href="qtcz3.jsp"><span>第三步</span></a></li>
				    <li><a href="qtcz4.jsp"><span>第四步</span></a></li>
				    <li><a href="qtcz5.jsp"><span>第五步</span></a></li></ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">输入您要充值的钱门账号</div>
					<div class="demoGifP">
						<a href="qtcz2.jsp"><img src="../_img/help/demo/qtcz1.gif" alt="给其他账户充值" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
