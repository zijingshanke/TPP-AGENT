 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="wjpapwd2.jsp"><span>第二步</span></a></li>
				    <li><a href="wjpapwd3.jsp"><span>第三步</span></a></li>
				    <li><a href="wjpapwd4.jsp"><span>第四步</span></a></li>
				    <li><a href="wjpapwd5.jsp"><span class="now">第五步</span></a></li>
					...
					<div class="demoGifP">
						<a href="wjpapwd6.jsp"><img src="../_img/help/demo/wjpapwd4.gif" alt="忘记交易密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
