							...
							<div class="contentRight">
								<div class="helpdetailed">
									<h1>
										...
										&nbsp;&nbsp;&nbsp;&nbsp;当您需要找回钱门账户的登录密码或支付密码时，系统会发送一封验证邮件到您的电子邮箱，若收不到邮件，可能是验证邮件被您的邮箱误认为是垃圾邮件放到了垃圾箱中，请检查一下。也可能是您的电子邮件所处的邮件服务器问题，请耐心等待几分钟，或者再多试几次，实在收不到的话，请联系您的邮件服务器提供者。
										<br/><br/><b>密码是最后一次的才有效，有些客户可能多次取回密码，但只有最后一次取回的密码才是有效的。</b> 
									<div class="helpAbout">
										相关问题：
									</div>
