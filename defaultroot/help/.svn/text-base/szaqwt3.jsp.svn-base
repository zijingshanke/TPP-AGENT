...
cha.className="changehelp";
 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 设置安全问题</span></div>
					<div class="navlist">
			    <ul>
				    <li><a href="szaqwt1.jsp"><span>第一步</span></a></li>
				    <li><a href="szaqwt2.jsp"><span>第二步</span></a></li>
				    <li><a href="szaqwt3.jsp" ><span class="now">第三步</span></a></li>
				    <li><a href="szaqwt4.jsp"><span>第四步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">确认设置的安全问题</div>
					<div class="demoGifP">
						<a href="szaqwt4.jsp"><img src="../_img/help/demo/szaqwt3.gif" alt="设置安全问题" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
