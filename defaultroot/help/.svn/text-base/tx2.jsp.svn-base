 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="tx2.jsp"><span class="now">第二步</span></a></li>
				    <li><a href="tx3.jsp"><span>第三步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">申请提现成功，等待钱门工作人员处理您的提现请求</div>
					<div class="demoGifP">
						<a href="tx3.jsp"><img src="../_img/help/demo/tx2.gif" alt="提现" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
