 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="szaqwt4.jsp"><span  class="now">第四步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">设置安全问题成功</div>
					<div class="demoGifP">
						<a href="#"><img src="../_img/help/demo/szaqwt4.gif" alt="设置安全问题" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
