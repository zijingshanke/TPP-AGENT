		...
		<div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="grzc5.jsp"><span class="now">第五步</span></a></li>
				    <li><a href="grzc6.jsp"><span>第六步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">补全信息</div>
					<div class="demoGifP">
						<a href="grzc6.jsp"><img src="../_img/help/demo/grzc5.gif" alt="个人注册" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
