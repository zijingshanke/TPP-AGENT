...
cha.className="changehelp";
 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 更换头像</span></div>
					<div class="navlist">
			    <ul>
				    <li><a href="ghtx1.jsp"><span class="now">第一步</span></a></li>
				    <li><a href="ghtx2.jsp"><span>第二步</span></a></li>
				    <li><a href="ghtx3.jsp"><span>第三步</span></a></li>
				    <li><a href="ghtx4.jsp"><span>第四步</span></a></li>
				    <li><a href="ghtx5.jsp"><span>第五步</span></a></li>
				    <li><a href="ghtx6.jsp"><span>第六步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">设置自己喜欢的头像</div>
					<div class="demoGifP">
						<a href="ghtx2.jsp"><img src="../_img/help/demo/ghtx1.gif" alt="头像设置" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
