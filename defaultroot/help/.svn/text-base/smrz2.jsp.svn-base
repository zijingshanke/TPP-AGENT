 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="smrz2.jsp"><span class="now">第二步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">同意服务协议</div>
					<div class="demoGifP">
						<a href="smrz3.jsp"><img src="../_img/help/demo/smrz2.gif" alt="实名认证" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
