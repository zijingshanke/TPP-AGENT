...
cha.className="changehelp";
 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 手机服务</span></div>
					<div class="navlist">
			    <ul>
				    <li><a href="sjfw1.jsp"><span>第一步</span></a></li>
				    <li><a href="sjfw2.jsp"><span>第二步</span></a></li>
				    <li><a href="sjfw3.jsp"><span class="now">第三步</span></a></li>
				    <li><a href="sjfw4.jsp"><span>第四步</span></a></li>
				    <li><a href="sjfw5.jsp"><span>第五步</span></a></li></ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">输入手机收到的验证码，勾中“我接受手机协议”</div>
					<div class="demoGifP">
						<a href="sjfw4.jsp"><img src="../_img/help/demo/sjfw3.gif" alt="手机服务" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
