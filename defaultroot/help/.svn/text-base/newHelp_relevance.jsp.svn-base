   ...
   <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
       ...
       <div id="right_box">
									...
									<div class="rightbox_title">
										<div class="rightbox_title_right">
											<div class="rightbox_title_count">
												<a href="../help/index.jsp" style="text-decoration:none;">帮助中心</a> >> <span>最新帮助</span>
											</div>
										</div>
									</div>
									<!-- 开始 -->
		   <div class="helpdetailed">
		       <ul>
					<li><a href="#" target="_blank">什么是钱门盾？</a></li>
                    <li><a href="#" target="_blank">为什么要使用钱门盾？</a></li>
                    <li><a href="#" target="_blank">个人协议是什么？</a></li>
                    <li><a href="#" target="_blank">个人用户如何申请接入钱门网关？</a></li>
                    <li><a href="#" target="_blank">忘记登录密码怎么办？</a></li>
                    <li><a href="#" target="_blank">《支付凭证》有什么作用？</a></li>
                    <li><a href="#" target="_blank">什么是商家订单号？</a></li>
                    <li><a href="#" target="_blank">管理员怎样将各账户的不同权限分别授权给操作员？</a></li>
                    <li><a href="#" target="_blank">没有通过实名认证能够进行什么操作？</a></li>
                    <li><a href="#" target="_blank">怎样进行实名认证？</a></li>
                    <li><a href="#" target="_blank">怎么下载对账单？</a></li>
				</ul>
		   </div>
	    </div>
