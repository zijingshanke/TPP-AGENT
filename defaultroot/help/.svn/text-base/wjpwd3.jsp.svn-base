...
cha.className="changehelp";
 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 忘记登录密码</span></div>
					<div class="navlist">
			    <ul>
				    <li><a href="wjpwd1.jsp"><span>第一步</span></a></li>
				    <li><a href="wjpwd2.jsp"><span>第二步</span></a></li>
				    <li><a href="wjpwd3.jsp"><span class="now">第三步</span></a></li>
				    <li><a href="wjpwd4.jsp"><span>第四步</span></a></li>
				    <li><a href="wjpwd5.jsp"><span>第五步</span></a></li>
				    <li><a href="wjpwd6.jsp"><span>第六步</span></a></li>
				    <li><a href="wjpwd7.jsp"><span>第七步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">例：使用证件号码找回登录密码</div>
					<div class="demoGifP">
						<a href="wjpwd4.jsp"><img src="../_img/help/demo/wjpwd3.gif" alt="忘记登录密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
