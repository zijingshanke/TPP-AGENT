 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				    <li><a href="wjpwd1.jsp"><span class="now">第一步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">找回登录密码</div>
					<div class="demoGifP">
						<a href="wjpwd2.jsp"><img src="../_img/help/demo/wjpwd1.gif" alt="忘记登录密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
