								...
								<div class="helpdetailed">
									<h1>
										...
										<table width="100%" cellpadding="0" cellspacing="0" class="tablebanking">
										  ...
										  <tr bgcolor="#FDFDD0">
										    <td width="30%"><strong>失败原因</strong></td>
										    <td width="70%"><strong>如何去做</strong></td>
										   </tr>
										  <tr>
											<td align="left">账户姓名和银行开户姓名不符</td>
											<td align="left">核对您的姓名和您填写的账号的银行开户姓名是否一致准确。</td>
										  </tr>
										  <tr>
											<td align="left">银行账号不存在或账号有误</td>
											<td align="left">请核对您选择的银行和您输入的银行账号是否一致，同时检查您输入的银行账号是否正确</td>
										  </tr>
										  <tr>
											<td align="left">银行账户省市或支行信息选择错误</td>
											<td align="left">请核对您填写的账号的开户行是否和您选择的开户行一致，省市是否正确</td>
										  </tr>
										  <tr>
											<td align="left">银行账户状态异常</td>
											<td align="left">请和银行核实您银行账户的状态，是否挂失、冻结、销户、欠费、非结算户或需要激活等</td>
										  </tr>
										  <tr>
											<td align="left">暂不支持该类银行账户</td>
											<td align="left">您填写的银行账户目前暂不支持提现，主要是由于您的账户为非结算户，国际卡，信用卡，E卡等，请更换银行账户</td>
										  </tr>
										  <tr>
											<td align="left">系统繁忙，请重试</td>
											<td align="left">您的开户行银行系统繁忙或者正在升级，您可以重新申请</td>
										  </tr>
