						...
						<div class="rightbox_count">
							...
							<div class="contentRight">
								<div class="helpdetailed">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;在支付过程中如果出现如图：<br />
									<img src="../_img/help/demo/urlcw.jpg" /><br /><br />
									&nbsp;&nbsp;&nbsp;&nbsp;（一）请清除所使用浏览器的缓存文件，重新打开浏览器后，再进行刚才的操作。<br /><br />
									<img src="../_img/help/demo/iesz.gif" /><br /><br />
									&nbsp;&nbsp;&nbsp;&nbsp;（二）如果第一步操作后还不能够正常进行，请及时联系钱门客服，钱门技术人员将在最短的时间内帮助您处理好。
