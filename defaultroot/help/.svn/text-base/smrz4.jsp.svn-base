...
cha.className="changehelp";
 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 实名认证</span></div>
					<div class="navlist">
			    <ul>
				    <li><a href="smrz1.jsp"><span>第一步</span></a></li>
				    <li><a href="smrz2.jsp"><span>第二步</span></a></li>
				    <li><a href="smrz3.jsp"><span>第三步</span></a></li>
				    <li><a href="smrz4.jsp"><span class="now">第四步</span></a></li>
				    <li><a href="smrz5.jsp"><span>第五步</span></a></li>
				    <li><a href="smrz6.jsp"><span>第六步</span></a></li>
				    <li><a href="smrz7.jsp"><span>第七步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">按照要求仔细填写您的银行相关信息</div>
					<div class="demoGifP">
						<a href="smrz5.jsp"><img src="../_img/help/demo/smrz4.gif" alt="实名认证" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
