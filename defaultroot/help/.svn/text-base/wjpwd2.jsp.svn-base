 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="wjpwd2.jsp"><span class="now">第二步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">输入您的钱门账号</div>
					<div class="demoGifP">
						<a href="wjpwd3.jsp"><img src="../_img/help/demo/wjpwd2.gif" alt="忘记登录密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
