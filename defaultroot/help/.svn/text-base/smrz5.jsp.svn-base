 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="smrz5.jsp"><span class="now">第五步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">确认您的银行相关信息</div>
					<div class="demoGifP">
						<a href="smrz6.jsp"><img src="../_img/help/demo/smrz5.gif" alt="实名认证" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
