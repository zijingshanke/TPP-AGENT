						...
						<div class="rightbox_count">
							...
							<div class="contentRight">
								<div class="helpdetailed">
									...
									&nbsp;&nbsp;&nbsp;&nbsp;钱门平台对全部用户信息、账户信息、加密、签名等进行128位加密。是一种国际标准的加密及身份认证通信协议。协议使用通讯双方的客户证书以及CA根证书，允许客户服务器应用以一种不能被偷听的方式通讯，在通讯双方间建立起了一条安全的、可信任的通讯通道。它具备以下基本特征：信息保密性、信息完整性、相互鉴定。当您的地址栏中出现锁型图片时，表明您正在填写的所有信息都处于128位的加密保护之下，其他人无法通过任何手段从网络中监测得到。您使用钱门网络一切服务时资料传输皆已经加密处理。
									<div class="helpAbout">
										相关问题：
									</div>
