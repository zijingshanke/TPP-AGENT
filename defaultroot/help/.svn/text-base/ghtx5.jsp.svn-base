 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				    <li><a href="ghtx1.jsp"><span>第一步</span></a></li>
				    <li><a href="ghtx2.jsp"><span>第二步</span></a></li>
				    <li><a href="ghtx3.jsp"><span>第三步</span></a></li>
				    <li><a href="ghtx4.jsp"><span>第四步</span></a></li>
				    <li><a href="ghtx5.jsp"><span class="now">第五步</span></a></li>
				    <li><a href="ghtx6.jsp"><span>第六步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">完成上传，更换头像</div>
					<div class="demoGifP">
						<a href="ghtx6.jsp"><img src="../_img/help/demo/ghtx5.gif" alt="头像设置" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
