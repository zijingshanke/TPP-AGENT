		      ...
		      <ul>
			    ...
			    <ul>
				   <li><a href="xzyh1.jsp"><span>第一步</span></a></li>
				    ...
				    <li><a href="xzyh3.jsp"><span>第三步</span></a></li>
				    <li><a href="xzyh4.jsp"><span class="now">第四步</span></a></li>
				    <li><a href="xzyh5.jsp"><span>第五步</span></a></li></ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">确认银行信息正确</div>
					<div class="demoGifP">
						<a href="xzyh5.jsp"><img src="../_img/help/demo/xzyh4.gif" alt="新增提现银行" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
