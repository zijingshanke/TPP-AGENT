...
<div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 提现</span></div>
					<div class="navlist">
			    <ul>
				    <li><a href="tx1.jsp"><span>第一步</span></a></li>
				    <li><a href="tx2.jsp"><span>第二步</span></a></li>
				    <li><a href="tx3.jsp"><span class="now">第三步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">等待1-2个工作日后，提现金额会充入您绑定的银行账户，并能收到我们的邮件</div>
					<div class="demoGifP">
						<a href="#"><img src="../_img/help/demo/tx3.gif" alt="提现" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
