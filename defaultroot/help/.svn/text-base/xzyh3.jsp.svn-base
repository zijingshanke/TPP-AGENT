...
<div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 新增提现银行</span></div>
					<div class="navlist">
			    <ul>
				   <li><a href="xzyh1.jsp"><span>第一步</span></a></li>
				    <li><a href="xzyh2.jsp"><span>第二步</span></a></li>
				    <li><a href="xzyh3.jsp"><span class="now">第三步</span></a></li>
				    <li><a href="xzyh4.jsp"><span>第四步</span></a></li>
				    <li><a href="xzyh5.jsp"><span>第五步</span></a></li></ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">按照要求仔细填写您的新银行账户相关信息</div>
					<div class="demoGifP">
						<a href="xzyh4.jsp"><img src="../_img/help/demo/xzyh3.gif" alt="新增提现银行" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
