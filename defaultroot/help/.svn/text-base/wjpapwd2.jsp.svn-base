...
cha.className="changehelp";
 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 忘记交易密码</span></div>
					<div class="navlist">
			    <ul>
				    <li><a href="wjpapwd1.jsp"><span>第一步</span></a></li>
				    <li><a href="wjpapwd2.jsp"><span class="now">第二步</span></a></li>
				    <li><a href="wjpapwd3.jsp"><span>第三步</span></a></li>
				    <li><a href="wjpapwd4.jsp"><span>第四步</span></a></li>
				    <li><a href="wjpapwd5.jsp"><span>第五步</span></a></li>
				    <li><a href="wjpapwd6.jsp"><span>第六步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">例：用证件号找回交易密码</div>
					<div class="demoGifP">
						<a href="wjpapwd3.jsp"><img src="../_img/help/demo/wjpapwd2.gif" alt="忘记交易密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
