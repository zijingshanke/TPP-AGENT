 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="ghtx4.jsp"><span class="now">第四步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">选中图片，并上传</div>
					<div class="demoGifP">
						<a href="ghtx5.jsp"><img src="../_img/help/demo/ghtx4.gif" alt="头像设置" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
