 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				    <li><a href="tx1.jsp"><span class="now">第一步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">输入提现金额，交易密码</div>
					<div class="demoGifP">
						<a href="tx2.jsp"><img src="../_img/help/demo/tx1.gif" alt="提现" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
