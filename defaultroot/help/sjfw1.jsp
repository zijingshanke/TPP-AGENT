 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				   <li><a href="sjfw1.jsp"><span class="now">第一步</span></a></li>
				    <li><a href="sjfw2.jsp"><span>第二步</span></a></li>
				    <li><a href="sjfw3.jsp"><span>第三步</span></a></li>
				    <li><a href="sjfw4.jsp"><span>第四步</span></a></li>
				    <li><a href="sjfw5.jsp"><span>第五步</span></a></li></ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">进入手机服务页面，点击申请绑定手机</div>
					<div class="demoGifP">
						<a href="sjfw2.jsp"><img src="../_img/help/demo/sjfw1.gif" alt="手机服务" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
