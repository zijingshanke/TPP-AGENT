										...
										<table width="100%" cellpadding="0" cellspacing="0" class="tablebanking">
										  <thead>
											<tr class="bankTitle"  bgcolor="#FDFDD0">
											  <td colspan="5"><strong>交通银行</strong>&nbsp;网银支付信息</td>
										    </tr>
											<tr>
											  <td>&nbsp;</td>
											  <td colspan="2">非签约用户</td>
											  <td colspan="2">签约用户</td>
											</tr>
										  </thead>
											<tr>
											  <td>&nbsp;</td>
											...
											<tr>
											  ...
											  <td colspan="2" align="left">手机动态密码用户：5000元；<br />
										      USB证书用户：50000元。</td>
										  </tr>
											<tr>
											  <td class="text12B">信用卡</td>
											  <td  colspan="2" align="left">手机动态密码用户：5000元和信用卡限额孰低；<br />
										      USB证书用户：10000元与信用卡限额孰低。</td>
										  </tr>
											<tr>
											  <td class="text12B">备注</td>
											  <td  colspan="4" align="left">1、借记卡自带普通版网银（即非签约客户）。但无转帐和支付功能，仅有查询功能。<br />
											    2、签约用户需到银行网点柜面开通网上银行，注明开通转帐、支付功能，并在14天内登录激活网上银行，单独做转账、支付功能的激活。 
										<br />
											   3、信用卡可以在柜面办理专业版网上银行，开通支付功能。       </td>
										  </tr>
										</table>
									<div class="helpAbout">
										相关问题：
