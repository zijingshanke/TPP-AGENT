 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
			    ...
			    <ul>
				    ...
				    <li><a href="smrz3.jsp"><span class="now">第三步</span></a></li>
					...
					<div class="h10"></div>
					<div class="demoTitleP">输入您注册时的真实姓名</div>
					<div class="demoGifP">
						<a href="smrz4.jsp"><img src="../_img/help/demo/smrz3.gif" alt="实名认证" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
