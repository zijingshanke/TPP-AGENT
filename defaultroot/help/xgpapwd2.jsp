...
cha.className="changehelp";
 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					<div class="bread">
					<div class="breadline">个人用户 >><span> 修改交易密码</span></div>
					<div class="navlist">
			    <ul>
				    <li><a href="xgpapwd1.jsp"><span>第一步</span></a></li>
				    <li><a href="xgpapwd2.jsp"><span class="now">第二步</span></a></li>
				    <li><a href="xgpapwd3.jsp"><span>第三步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">设置您新的交易密码</div>
					<div class="demoGifP">
						<a href="xgpapwd3.jsp"><img src="../_img/help/demo/xgpapwd2.gif" alt="修改交易密码" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
