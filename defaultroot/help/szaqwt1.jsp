 ...
 <div class="changehelp" id="change1" onclick="javascript:ShowFLT(1)">
		      ...
		      <ul>
				...
				<div class="clearfix">
					...
					<div class="navlist">
			    <ul>
				    <li><a href="szaqwt1.jsp"><span class="now">第一步</span></a></li>
				    <li><a href="szaqwt2.jsp"><span>第二步</span></a></li>
				    <li><a href="szaqwt3.jsp"><span>第三步</span></a></li>
				    <li><a href="szaqwt4.jsp"><span>第四步</span></a></li>
				</ul>
			</div>
					</div>
					<div class="h10"></div>
					<div class="demoTitleP">设置安全问题</div>
					<div class="demoGifP">
						<a href="szaqwt2.jsp"><img src="../_img/help/demo/szaqwt1.gif" alt="设置安全问题" width="540" border="0" />
						</a>
					</div>
					</div>
				</div>
