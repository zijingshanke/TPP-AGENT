...
<!--JSP页面: agent/editBindAccount.jsp -->	
  ...
  <c:import url="/_jsp/topMenu.jsp?a=1,6&b=0,7,5,6" />
        ...
        <div class="main_mid">
          <div class="main_title">
            <div class="main_title_right">
              <p><strong>成功提交</strong><a href="agent.do?thisAction=viewMyAgent" class="a_style1">返回我的账户</a></p>
            </div>
          </div> 
          <html:form action="/agent/agent.do?thisAction=changeBindBank">
	...
	<p><input type="radio" style="width: 25px" name="bindAccount" value="<c:out value="${account.id}"></c:out>"><c:out value="${account.haskCardNo}"></c:out>[<c:out value="${account.bankName}"></c:out>]</input></p>
            ...
            <tr>
              <td>&nbsp;</td>
              <td>
              	<input type="submit" value="确 认" class="btn1" />
              </td>
            </tr>
          </table>
          </html:form>
