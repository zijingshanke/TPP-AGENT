...
<!--JSP页面: transaction/transactionBorrowAndRepayment.jsp -->
...
<script language="javascript">
		...
		function chooseType(){
			...
			window.location.href="../transaction/transactionlist.do?thisAction=getBorrowAndRepaymentList&agentType="+agentType+"&menuList="+menuList+"&status="+status;
		}
...
<html:form action="transaction/transactionlist.do" method="post">
	...
	<table cellpadding="0" cellspacing="0" width="100%"
		...
		<tr>
			...
			<td>
			<html:text styleId="beginDate" property="beginDate" styleClass="text_style" onclick="custom();" readonly="false"
				onfocus="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})"  />
			--
			<html:text styleId="endDate" property="endDate" styleClass="text_style" onclick="custom();" readonly="false"
				onfocus="WdatePicker({startDate:'%y-%M-01 00:00:00',dateFmt:'yyyy-MM-dd HH:mm:ss',alwaysUseStartDate:true})"  />
