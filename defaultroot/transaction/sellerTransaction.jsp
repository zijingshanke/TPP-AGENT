...
<!--JSP页面: transaction/sellerTransaction.jsp -->
...
<script language="javascript">
		...
		function getTransactionDetailById(tid,statusid,orderid,flag,agentid,type){
			window.location.href="../transaction/transaction.do?thisAction=getTransactionDetailById&flag="+flag+"&type="+type+"&agentid="+agentid+"&statusid="+statusid+"&tid="+tid+"&orderid="+orderid;
		}
		
		function getTransactionSuccessAndFailDetail(tid,statusid,orderid,flag,agentid,type){
			window.open("../transaction/transaction.do?thisAction=getTransactionSuccessAndFailDetail&flag="+flag+"&type="+type+"&agentid="+agentid+"&statusid="+statusid+"&tid="+tid+"&orderid="+orderid+"&fg=seller");
		}
		
		function viewTradeTransactionFail(tid,statusid,orderid,flag,agentid,type){
			window.location.href="../transaction/transaction.do?thisAction=viewTradeTransactionFail&flag="+flag+"&type="+type+"&agentid="+agentid+"&statusid="+statusid+"&tid="+tid+"&orderid="+orderid;
		}
		
		function transactionDetailByDunAndBatch(tid,statusid,orderid,flag,agentid,type){
			window.open("../transaction/transaction.do?thisAction=transactionDetailByDunAndBatch&flag="+flag+"&type="+type+"&agentid="+agentid+"&statusid="+statusid+"&tid="+tid+"&orderid="+orderid+"&seller=1");
		}
		
		function viewTradeTransactionSuccess(tid,statusid,orderid,flag,agentid,type){
			window.open("../transaction/transaction.do?thisAction=viewTradeTransactionSuccess&flag="+flag+"&type="+type+"&agentid="+agentid+"&statusid="+statusid+"&tid="+tid+"&orderid="+orderid);
		}
		...
		function getTransactionPaymentDetailById(tid,statusid,orderid,flag,agentid,type){
			if(flag==1){
				if(type==0)
					...
					window.location.href="../transaction/transaction.do?thisAction=getTransactionPaymentDetailById&flag="+flag+"&agentid="+agentid+"&statusid="+statusid+"&tid="+tid+"&orderid="+orderid+"&type="+type;
			}
			else
				window.location.href="../transaction/transaction.do?thisAction=getTransactionPaymentDetailById&flag="+flag+"&statusid="+statusid+"&tid="+tid+"&orderid="+orderid+"&type="+type;
		}
		...
		function transactionRepayment(tid){
			window.location.href="../transaction/transaction.do?thisAction=repayment&tid="+tid;
		}
		...
		function userMark(tid,orderid){
			window.location.href="../transaction/transaction.do?thisAction=userMark&tid="+tid+"&orderid="+orderid+"&fg=seller";
		}
		...
		function viewTradeSellerRefund(tid,orderid,flag,fg){ 
			window.open("../transaction/transaction.do?thisAction=viewTradeSellerRefund&tid="+tid+"&orderid="+orderid+"&flag="+flag+"&fg="+fg);
		}
...
<body>
<div id="warp"><c:import url="/_jsp/topMenu.jsp?a=1,6&b=0,7,9,6" />
<div class="main_top">
...
<html:form action="transaction/transactionlist.do?thisAction=getSellerAndBuyerTransactionList&fg=seller" method="post">
	...
	<table cellpadding="0" cellspacing="0" width="100%"
		...
		<tr id="searchMoneyTR">
			...
			<td>
			<html:text property="searchBeginMoney" styleId="searchBeginMoney" onfocus="this.value=''" styleClass="text_style" onkeyup="value=value.replace(/[^.0-9]/g,'')" onchange="value=value.replace(/[^.0-9]/g,'')"></html:text>
			--
			<html:text property="searchEndMoney" styleId="searchEndMoney"  onfocus="this.value=''" styleClass="text_style" onkeyup="value=value.replace(/[^.0-9]/g,'')" onchange="value=value.replace(/[^.0-9]/g,'')"></html:text>
			</td>
		</tr>
		<tr>
	...
	<a id="Show_10"	onclick="AllTransaction();" style="cursor:hand"	class="at_deal_list_head">所有卖出交易</a>
	...
	<table cellpadding="0" cellspacing="0" width="100%" class="deal_table" style="word-break :break-all">
		...
		<c:forEach var="info" items="${tlf.list}" varStatus="statu">
			<tr>
				...
				<td><!-- 可执行操作开始 --> <c:forEach var="lf"
					items="${info.tradeOperate}" varStatus="st">
...
<script language="javascript">
	...
	function AllTransaction(){
		    Show_Menu(1,0);
			document.forms[0].action="../transaction/transactionlist.do?thisAction=getSellerAndBuyerTransactionList&fg=seller&menuList=1,0&flag=1&status=''";
			smb();
		}
	function Transactions(){
		    Show_Menu(1,1);
			document.forms[0].action="../transaction/transactionlist.do?thisAction=getSellerAndBuyerTransactionList&fg=seller&menuList=1,1&status=1&flag=1";
			smb();
		}
	function SuccessTransaction(){
	    Show_Menu(1,2);
		document.forms[0].action="../transaction/transactionlist.do?thisAction=getSellerAndBuyerTransactionList&fg=seller&menuList=1,2&status=3&flag=1";
		smb();
	}
  function FailureTransaction(){
	    Show_Menu(1,3);
		document.forms[0].action="../transaction/transactionlist.do?thisAction=getSellerAndBuyerTransactionList&fg=seller&menuList=1,3&status=4&flag=1";
		smb();
	}
  function RefundTransaction(){
	    Show_Menu(1,4);
		document.forms[0].action="../transaction/transactionlist.do?thisAction=getSellerTransactionRefundList&flag=1";
		smb();
	}
</script>
</html>
