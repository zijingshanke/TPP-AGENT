...
<!--JSP页面: transaction/viewTradeBuyTransactionSuccess.jsp -->
        ...
        <table cellpadding="0" cellspacing="0" width="680" class="deal_table" style="margin-top: 12px; float:left">
          ...
          <tr bgcolor="#F8F8F8">
           ...
           <tr bgcolor="#F8F8F8">
                 ...
                 <td colspan="2"><fmt:formatDate pattern="yyyy年MM月dd日 HH:mm:ss" value="${transaction.orderDetails.finishDate}"/></td>
          </tr>
           <tr bgcolor="#F8F8F8">
                 <td colspan="5">支付说明</td>
          </tr>
           <tr bgcolor="#F8F8F8">
                 <td colspan="5"><c:out value="${transaction.orderDetails.detailsContent}"/></td>
          </tr>
        </table>
