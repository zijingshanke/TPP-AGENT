...
<!--JSP页面: transaction/transactionDebitAndExpense.jsp -->
...
<script language="javascript">
		...
		function chooseType(){
			...
			window.location.href="../transaction/transactionlist.do?thisAction=getDebitAndExpenseList&agentType="+agentType+"&menuList="+menuList+"&status="+status;
		}
