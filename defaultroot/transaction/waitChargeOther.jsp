...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<!--JSP页面: transaction/waitChargeOther.jsp -->
...
function sendToBank(form)
{
 ...
 var agentId="<c:out value="${agentMy.id}" />";
  ...
  if(bank=='ICBC'){
	...
	<body>
		<html:form action="/transaction/charge.do">
			<html:hidden property="amount" value="${charge.amount}" />
			<html:hidden property="agentId" value="${agentMy.id}" />
			<html:hidden property="agentOtherId" value="${agentOther.id}" />
			<html:hidden property="type" value="${charge.type}" />
											...
											<div class="paymentSuccessfulTitle">
												<table class="right_count_tabel">
													...
													<tr>
														...
														<td>
															<span class="font_style2"><c:out
																	value="${agentOther.name}"></c:out> </span>
														</td>
													</tr>
													<tr>
														<td align="right">
														...
														<td>
															<span class="font_style2"><c:out
																	value="${agentOther.loginName}"></c:out> </span>
														</td>
													</tr>
													<tr>
														<td align="right">
