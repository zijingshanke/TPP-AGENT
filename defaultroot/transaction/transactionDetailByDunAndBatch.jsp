...
<!--JSP页面: transaction/transactionDetailByDunAndBatch.jsp -->
    ...
    <div class="main_top">
     ...
     <div class="main_top">
      <div class="main_bottom">
    	...
    	<div class="main_title_right">
	    	<c:if test="${flag==1}">
	        	<p><strong>等待对方付款</strong>&nbsp;<html:link page="/transaction/transactionlist.do?thisAction=listTransactions&flag=1">返回交易管理</html:link></p>
	       </c:if>
	       <c:if test="${flag==0}">
	        	<p><strong>等待你付款</strong>&nbsp;<html:link page="/transaction/transactionlist.do?thisAction=listTransactions&flag=1">返回交易管理</html:link></p>
	       </c:if>
        ...
        <table cellpadding="0" cellspacing="0" width="680" class="deal_table" style="margin-top: 12px; float:left">
          ...
          <tr>
          		<td colspan="3"><strong>支付说明：</strong><c:out value="${transaction.orderDetails.detailsContent}"/></td>
          </tr>
        </table>
        <div class="tableRight">
            <span class="speak">
		         ...
		         <tr align="center">
		          ...
		          <tr align="center">
		          	<td align="center" colspan="3">
			 			<input type="button" class="btn1" name="actionPayment" value="立即付款" onclick="transactionPayment('<c:out value="${transaction.id}" />','<c:out value="${transaction.status}" />','<c:out value="${transaction.orderDetails.id}" />')"/>
			 	    </td>
		          </tr>
