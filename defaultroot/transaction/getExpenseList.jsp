...
<!--JSP页面: transaction/getExpenseList.jsp -->	
        ...
        <div class="leftbox_top">
          <div class="leftbox_bottom">
            <div class="leftbox_count">
              <p class="leftbox_count_p"><a href="../transaction/transactionlist.do?thisAction=getExpenseList">申请报销记录</a></p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div class="rightbox_top">
          <div class="rightbox_bottom">
            <div class="rightbox_count">
              ...
              <html:form action="/transaction/transactionlist.do?thisAction=getExpenseList" method="post">
                ...
                <table cellpadding="0" cellspacing="0" width="100%" class="deal_table" style="margin-top: 12px;">
                      <tr>
                        <th width="14%"><div align="center">申请时间</div></th>
                        <th width="10%"><div align="center">预支单号</div></th>
                        <th width="10%"><div align="center">报销单号</div></th>
                        <th width="25%"><div align="center">报销原因</div></th>
                        <th width="15%"><div align="center">预支金额（元）</div></th>
                        <th width="15%"><div align="center">报销金额（元）</div></th>
                        <th width="11%"><div align="center">状态</div></th>
                      </tr>
                      <tr>
                        <c:forEach var="info" items="${tlf.list}" varStatus="status">
							<tr>
								...
								<td align="center"><c:out value="${info.debit.no}"/></td>
								<td align="center"><c:out value="${info.no}"/></td>
								<td align="center"><c:out value="${info.remark}"/></td>
								<td align="center"><fmt:formatNumber value="${info.debit.amount}" pattern="0.00"/></td>
								<td align="center"><fmt:formatNumber value="${info.amount}" pattern="0.00"/></td>
								<td align="center"><c:out value="${info.expenseStatus}" /></td>
							</tr>
						</c:forEach>
                      </tr>
                      <tr>
