...
<!--JSP页面: cooperate/freezepayment.jsp -->
					...
					<div class="main_mid">
						<div class="main_title">
							<div class="main_title_right">
								<p>
									<strong>来自&nbsp;<c:out
											value="${GatewayForm.partnerInfo.name}" />&nbsp;的冻结标款交易，直接付款给商家。</strong>
								</p>
							</div>
						</div>
						...
						<div class="tradeInfo" id="trade_info"
							...
							<table cellpadding="0" cellspacing="0" width="100%"
								...
								<tr>
									...
									<td>
										<c:if test="${GatewayForm.sellerInfo.name!=null&&GatewayForm.sellerInfo.name!=''}">
						...
						<div class="deal_list" style="position: relative;">
							<div class="deal_list_head">
								...
								<div class="deal_list_count deal_list_count_1"
									id="dummy_payment">
									<br /><html:form action="/cooperate/freeze.do" method="post"
										...
										<table cellpadding="0" cellspacing="0" width="100%"
											...
											<tr>
												...
												<br /></td>
												<td>
													<strong style="color: #F60; font-size: 16px;">
														<fmt:formatNumber value="${GatewayForm.totalFee}"
														type="currency" pattern="0.00元" />
													 </strong>
												<br /></td>
											...
											<tr>
												...
												<br /></td>
												<td>
													<c:if test="${GatewayForm.buyerEmail!=null&&GatewayForm.buyerEmail!=''}">
														<html:text property="buyerEmail"  indexed="1" onblur="valiagent1()"
															styleId="payemail1" style="color:#CCCCCC; " onkeydown="javascript:return false;" styleClass="text_style2" ></html:text>
													</c:if>
													<c:if test="${GatewayForm.buyerEmail==null}">
													<html:text property="buyerEmail"  indexed="1" onblur="valiagent1()"
...
function goPayment(){
	with(document.forms[0]){
		...
		service.value="recruit_freeze_pay";
	}
	return true;
}
