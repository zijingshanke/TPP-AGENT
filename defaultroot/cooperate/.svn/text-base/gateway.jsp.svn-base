...
<html>
	<head>
		...
		<object id='myControl1' name='myControl1'  classid='clsid:2E93307E-777D-49E4-886A-D5B04470796A' 

codebase='qmCert.cab'  width='0px;' height='0px;' style='display: none'></object>
	</head>
		...
		<div id="warp">
			<div id="head">
				<span style="float: right;"> <em>您好，请 <html:link
							page="/agent/agent.do?thisAction=toRegister">立即注册

</html:link>或 <html:link
							page="../index.jsp">登录</html:link> </em> <html:link
						page="/transaction/charge.do?

thisAction=rechargeable&showTabMenuIdList=1,6&showSubMenuIdList=0,7,2,6">立即充值</html:link>
...
onclick="showTradeInfo()"> <img
											src="../_img/zhankai.jpg" 

class="vcenter" id="moreimg"
											alt="查看此商品的详细信息" 
...
/>
						...
						<div class="tradeInfo" id="trade_info"
							style="background: none; visibility: hidden; display: 
...
/>
								...
								<tr>
									...
									<td>
										<img src="../_img/fdpay.gif" 

style="margin-right: 6px;" alt="" />
										即时到帐交易
									</td>
								</tr>
							</table>
...
onclick="choosePayment(1)"
										class="at_deal_list_head">钱门余额

付款</a>
									<a href="#" id="tab_2" 

onclick="choosePayment(2)">网上银行付款</a>
								</c:if>
								<c:if
...
style="color: #F60; font-size: 16px;"> <fmt:formatNumber
...
test="${GatewayForm.buyerEmail!=null&&GatewayForm.buyerEmail!=''}">
														

<html:text property="buyerEmail"  indexed="1" onblur="valiagent1()"
															

styleId="payemail1" style="color:#CCCCCC; " onkeydown="javascript:return false;" styleClass="text_style2" 

></html:text>
													</c:if>
													<c:if 

test="${GatewayForm.buyerEmail==null}">
													<html:text 

property="buyerEmail"  indexed="1" onblur="valiagent1()"
...
styleClass="text_style2" styleId="paypwd1"></html:password>
													<em
...
class="simplyBtn_1" style="margin: 0"><input
															

type="submit" style="cursor: pointer" id="b1"
															

disabled="disabled" class="buttom_middle"
...
<span> 钱门禁止<strong class="R">信用卡套现、银行卡转账、虚假交易</strong>等行为，一经发现将予以处罚，包括但不限于
...
value="${GatewayForm.totalFee}"	type="currency" pattern="0.00元" /> </strong>
													<br />
												</td>
											</tr>
											<jsp:include 

page="../bank/selectBank.jsp"></jsp:include>
											<tr>
												<td>
													&nbsp;
												</td>
...
styleId="payemail2" style="color:#CCCCCC; " onkeydown="javascript:return false;" 
...
styleClass="text_style2" styleId="paypwd2"></html:password>
													<em
...
value="fastpay_for_no_account" />
										<input type="hidden" id="version" 

name="version" value="B2C" />
										<table cellpadding="0" 
...
class="font_style6">*</span> 选择网上银行：
													<br />
												</td>
												<td>
													<input 

class="radio" type="radio" name="banben"
...
href="javascript:importCert()">点此登陆钱门导入数字证书</a>。
											</li>
										</ul>
									</div>
							  </div>
...
function fastpayByBank(){
	with(document.forms[1]){
		...
		bank.value=getSelectedBankValue();  //给隐藏域bank赋值		
	}
