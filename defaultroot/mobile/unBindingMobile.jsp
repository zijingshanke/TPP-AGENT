      ...
      <div class="main_bottom">
        <div class="main_mid">
          ...
          <div class="yellowBox_Check">
            ...
            <p style="color:#666;">如果您换手机号码了，无法收到验证码，您可以通过<span class="simplyBtn_1 simplyBtn_11"><input type="button" class="buttom_middle" value="安全保护问题取消手机绑定" onclick="unBindingMobile();" /></span>&nbsp;，或者<a href="#" style="color: #005C9C;">提交申请单</a>联系客服处理。</p>
          ...
          <div class="blueBox_1" style="width:500px;">
          	您已经于申请取消手机绑定。（手机号码为：<c:out value="${URI.agent.mobilePhone}"></c:out>）
          </div>
          ...
          <html:hidden property="mobilePhone" value="${URI.agent.mobilePhone}"></html:hidden>
              <table cellpadding="0" cellspacing="0" width="100%" class="information_table">
                <tr>
                  ...
                  <td><html:text property="mobileValidateCode" styleClass="inputText"></html:text>
                ...
                <tr>
                  ...
                  <td><html:password property="payPassword"></html:password>
