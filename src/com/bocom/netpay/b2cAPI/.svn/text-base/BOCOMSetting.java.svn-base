...
//		System.out.println("BCMB2C BOCOMSetting parseXML(String xmlFile):"		+ xmlFile);
...
//							System.out.println("LogPath>>" + LogPath);
						...
						try {
							SettlementFilePath = Constant.WEB_INFO_PATH
									+ cnode.getNodeValue().trim();
							// System.out.println("SettlementFilePath>>" + SettlementFilePath);
						} catch (Exception e1) {
						...
						try {
							MerchantCertFile = Constant.WEB_INFO_PATH
									+ cnode.getNodeValue().trim();
//							System.out.println("MerchantCertFile>>" + MerchantCertFile);
						} catch (Exception e1) {
