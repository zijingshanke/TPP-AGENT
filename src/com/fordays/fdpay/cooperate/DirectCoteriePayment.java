...
public class DirectCoteriePayment implements Runnable
{
	AgentBindBiz biz;
	//AgentBindBiz agentBindBiz;
	...
	public DirectCoteriePayment(AgentBindBiz Biz,String result)
	{
		this.biz = Biz;
		this.result=result;
	}
	...
	public void run()
	{
		try
		{
			...
			// String result=biz.payment(map,userAgent,
			// url,encoding,isPayByBank,gatewayMessage);
			//
...
//					String context="SUCCESS";
	...
	public DirectCoteriePayment(String result)
	{
		super();
		this.result = result;
	}
	...
	private void log(String context,int status) throws Exception
	{
		...
		orderDetails = biz.getOrderDetails(map.get("out_trade_no"), map
		    .get("partner"));
