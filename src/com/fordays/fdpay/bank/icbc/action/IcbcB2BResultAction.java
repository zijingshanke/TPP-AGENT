...
import com.fordays.fdpay.bank.icbc.IcbcB2BResultFromBank;
 ...
 * @接收工商银行B2B订单处理结果
 */
public class IcbcB2BResultAction extends BankAction {
	...
	public ActionForward unspecified(ActionMapping mapping, ActionForm form,
			...
			throws AppException {
		ResultFromBank icbcresult = icbcBankBiz.getB2BResult(request);
